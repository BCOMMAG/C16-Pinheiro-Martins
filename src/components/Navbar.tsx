      ...
      >
        <div className="max-w-7xl mx-auto px-2.5 sm:px-6 lg:px-8">
          <div className="relative min-h-[2.5rem] sm:min-h-[3rem] flex items-center justify-between gap-2 sm:gap-4">
            ...
            {/* 1. Logo Mobile: Perfeitamente alinhada na mesma linha central dos botões do menu (-15% no tamanho) */}
            <div className="lg:hidden flex items-center justify-start relative flex-shrink-0 w-24 sm:w-28 max-w-[28vw] h-10 pointer-events-none">
              <div className="absolute left-0 top-1/2 -translate-y-1/2 pointer-events-auto">
                ...
                >
                  <div className="relative h-[3.8rem] sm:h-[4.25rem] w-24 sm:w-28 max-w-[28vw] transition-transform duration-300 group-hover:scale-105">
                    <Image
                      src={currentLogo}
            ...
            {/* 2. Logo Desktop: Totalmente Desacoplada e perfeitamente centralizada (-15% no tamanho, clique retorna ao topo) */}
            <div className="hidden lg:flex items-center justify-start relative flex-shrink-0 w-44 xl:w-54 h-10 pointer-events-none">
              <div className="absolute left-0 top-1/2 -translate-y-1/2 pointer-events-auto">
                <Link
                  href="/"
                  onClick={handleLogoClick}
                  ...
                  aria-label="Ir para a página inicial"
                >
                  <div className="relative h-[4.25rem] xl:h-[5.1rem] w-44 xl:w-54 transition-transform duration-300 group-hover:scale-105">
                    <Image
                      src={currentLogo}
                      alt={OFFICE_INFO.name}
                      fill
                      ...
                      sizes="(min-width: 1280px) 270px, 220px"
                    />
                  </div>
                </Link>
              </div>
                  ...
                  <div className="absolute top-full left-0 w-64 p-2 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-subtle)] shadow-xl animate-fade-in-down z-50 text-[var(--text-main)]">
                    ...
                    >
                      <div>
                        ...
                        <span className="text-[0.6875rem] text-[var(--text-muted)] font-body">
                          Desde 2022 • Rigor Técnico & Humanizado
                        </span>
                      </div>
                      <ArrowUpRight className="w-3.5 h-3.5 text-[var(--text-muted)] group-hover:text-[var(--accent)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                    </Link>
                    ...
                    >
                      <div>
                        ...
                        <span className="text-[0.6875rem] text-[var(--text-muted)] font-body">
                          4 etapas do atendimento presencial e digital
                        </span>
                      </div>
                      <ArrowUpRight className="w-3.5 h-3.5 text-[var(--text-muted)] group-hover:text-[var(--accent)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                    </Link>
                  ...
                  <div className="absolute top-full left-0 w-72 p-2 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-subtle)] shadow-xl animate-fade-in-down z-50 text-[var(--text-main)]">
                    ...
                    >
                      <div>
                        ...
                        <span className="text-[0.6875rem] text-[var(--text-muted)] font-body">
                          Família, Cível, Bancário, Previdenciário (9 Áreas)
                        </span>
                      </div>
                      <ArrowUpRight className="w-3.5 h-3.5 text-[var(--text-muted)] group-hover:text-[var(--accent)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                    </Link>
                    ...
                    >
                      <div>
                        ...
                        <span className="text-[0.6875rem] text-[var(--text-muted)] font-body">
                          Artigos e orientações didáticas (CFOAB)
                        </span>
                      </div>
                      <ArrowUpRight className="w-3.5 h-3.5 text-[var(--text-muted)] group-hover:text-[var(--accent)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                    </Link>
          ...
          <div>
            <div className="flex items-center justify-between pb-4 border-b border-[var(--border-subtle)]/25">
              <Link
                ...
                aria-label="Ir para a página inicial"
              >
                <div className="relative h-[3.8rem] w-42">
                  <Image
                    src={drawerLogo}
                    alt={OFFICE_INFO.name}
                    fill
            ...
            <div className="my-4 flex items-center gap-2 px-3 py-1.5 rounded-full border border-[var(--accent)]/30 bg-[var(--bg-secondary)] text-xs font-heading text-[var(--text-main)]">
              ...
              <span>Pinheiro & Martins • Desde 2022 • Curitiba/PR</span>
            </div>
