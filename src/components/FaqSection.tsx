...
export function FaqSection() {
  ...
  const [activeTab, setActiveTab] = useState<string>("familia-sucessoes");
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="pt-4 mt-4 border-t border-[var(--border-subtle)]/15 flex items-center justify-between flex-wrap gap-3">
                      ...
                      <a
                        href={`https://wa.me/${OFFICE_INFO.whatsappNumber}?text=${encodeURIComponent(
                          `Olá, Pinheiro & Martins Advocacia! Vi no FAQ a dúvida sobre "${item.question}" e gostaria de saber mais sobre o meu caso.`
                        )}`}
                        target="_blank"
        ...
        >
          ...
          <p className="font-body text-xs sm:text-sm text-[var(--text-muted)] max-w-md mx-auto mb-5 leading-relaxed">
            Cada demanda jurídica possui particularidades contratuais, prazos processuais e especificidades patrimoniais. Envie uma mensagem no WhatsApp para análise detalhada com nossa equipe.
          </p>
          <a
          ...
          >
            ...
            <span>Falar no WhatsApp com Advogado</span>
          </a>
        </div>
      </div>
    </section>
