...
export default function LinksPage() {
  const quickLinks = [
    {
      id: "whatsapp",
      title: "WhatsApp Oficial do Escritório",
      subtitle: "Atendimento ágil e agendamento de consultas",
    ...
    },
    {
      ...
      subtitle: "Conheça nossas 9 especialidades jurídicas",
      href: "/",
      icon: Globe,
      highlight: false,
    },
    {
      id: "familia",
      title: "Família, Divórcio & Inventários",
      subtitle: "Partilha de bens, pensão e inventário em cartório",
      href: `https://wa.me/${OFFICE_INFO.whatsappNumber}?text=${encodeURIComponent(
        "Olá, Pinheiro & Martins Advocacia! Gostaria de consultoria sobre Direito de Família e Inventário."
      )}`,
      icon: HeartHandshake,
      highlight: false,
    },
    {
      ...
      title: "Bancário, Imobiliário & Tributário",
      subtitle: "Revisão de contratos, execuções e imóveis",
      href: `https://wa.me/${OFFICE_INFO.whatsappNumber}?text=${encodeURIComponent(
        "Olá, Pinheiro & Martins Advocacia! Gostaria de consultoria sobre Direito Bancário e Tributário."
      )}`,
      icon: Landmark,
      highlight: false,
    },
    {
      ...
      subtitle: "@pinheiroemartins_advocacia • Conteúdo jurídico",
    ...
    },
    {
      ...
      subtitle: "Pinheiro & Martins Advocacia e Assessoria",
  ...
  return (
    <main className="min-h-[100dvh] lg:h-screen lg:max-h-screen lg:overflow-hidden w-screen max-w-full bg-[#FFFFFF] text-[#0B192C]">
      ...
      <div className="hidden lg:grid lg:grid-cols-2 h-full w-full overflow-hidden">
        ...
        <div className="bg-[#FFFFFF] flex flex-col justify-between p-6 xl:p-8 h-full overflow-y-auto">
          <div className="max-w-md mx-auto w-full flex flex-col justify-center my-auto space-y-3 xl:space-y-3.5 py-4">
            ...
            {/* Caixa de Especialidades Jurídicas */}
      ...
      <div className="lg:hidden relative flex flex-col justify-between h-[100dvh] max-h-[100dvh] w-full px-4 py-3 sm:py-4 overflow-hidden bg-gradient-to-b from-[#FFFFFF] via-[#F8FAFC] to-[#EEF2F6]">
        ...
        {/* Topo Mobile - Logo Dobrada Centralizada + Pílulas Compactas */}
        ...
        {/* Links Mobile - Distribuídos harmoniosamente com ZERO scroll */}
